...
# merge with MODY df
MODY_df = MODY_df.join(append_filtered_genes_to_MODY)
print(MODY_df['Stage 0: wild type_01'])
...
plt.title('Decoy seq strategy: PEP distribution of canonical and variant PSMs from classified iPSCs of possible MODY genes')
plt.legend(MODY_df.columns, bbox_to_anchor=(1, 1), loc='upper left', title='iPSCs growth stage and type')
plt.savefig('iPSCs all MODY pep distribution decoy sequence search', bbox_inches='tight', dpi=600)
plt.show()
