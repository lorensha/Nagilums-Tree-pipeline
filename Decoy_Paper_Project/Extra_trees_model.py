...
def extra_trees_main_predictor(psm_input_file):
    ...
    # select target PSMs within the 1% FDR threshold and random decoy PSMs from the psm dataset
...
def counting_system(input_psms_original, targets_count_list, predictor_dataframe_list):
    ...
    if last_iteration_target_count >= second_last_iteration_target_count:
        print(">> Count improved or equal — rerunning with re-ranked dataset...")
        ...
        print(">> Count did not improve — selecting best output and saving...")
