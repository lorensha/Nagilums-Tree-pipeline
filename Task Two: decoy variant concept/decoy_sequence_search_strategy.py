...
processed_iPSC_directory_confusion_matrix_only = 'Decoy Seq: iPSCs processed confusion matrix only'
merged_processed_iPSCs_with_input_files = 'Decoy Seq: iPSCs merged dataframes'
...
for filename in os.scandir(iPSCs_directory):
    if filename.is_file():
        ...
        # setup for decoy_seq as decoy PSM, assign negative class label
        ...
        # remove decoy variant PSMs
        stem_psm_dataset = iPSC_file[iPSC_file['psm_type'] != 'target_seq_decoy_var']
