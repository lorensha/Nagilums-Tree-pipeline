...
MODY_file = pd.read_table('MD_genes_new_02.txt', header=None)
...
# STEM FILE 01
stem_file_01_df = pd.read_csv('Decoy Seq Stem Cell File 1.csv', header=0)
stem_file_01_df = stem_file_01_df[stem_file_01_df['pep_scores'] <= 1.0]

# remove decoys of canonical and variants
stem_file_01_df = stem_file_01_df[stem_file_01_df['psm_type'] == 'target_seq_target_var']
...
# STEM FILE 02
stem_file_02_df = pd.read_csv('Decoy Seq Stem Cell File 2.csv', header=0)
stem_file_02_df = stem_file_02_df[stem_file_02_df['pep_scores'] <= 1.0]

# remove decoys of canonical and variants
stem_file_02_df = stem_file_02_df[stem_file_02_df['psm_type'] == 'target_seq_target_var']
...
# STEM FILE 03
stem_file_df_03 = pd.read_csv('Decoy Seq Stem Cell File 3.csv', header=0)
stem_file_df_03 = stem_file_df_03[stem_file_df_03['pep_scores'] <= 1.0]

# remove decoys of canonical and variants
stem_file_df_03 = stem_file_df_03[stem_file_df_03['psm_type'] == 'target_seq_target_var']
...
# STEM FILE 04
stem_file_df_04 = pd.read_csv('Decoy Seq Stem Cell File 4.csv', header=0)
stem_file_df_04 = stem_file_df_04[stem_file_df_04['pep_scores'] <= 1.0]

# remove decoys of canonical and variants
stem_file_df_04 = stem_file_df_04[stem_file_df_04['psm_type'] == 'target_seq_target_var']
...
# STEM FILE 05
stem_file_df_05 = pd.read_csv('Decoy Seq Stem Cell File 5.csv', header=0)
stem_file_df_05 = stem_file_df_05[stem_file_df_05['pep_scores'] <= 1.0]

# remove decoys of canonical and variants
stem_file_df_05 = stem_file_df_05[stem_file_df_05['psm_type'] == 'target_seq_target_var']
...
# STEM FILE 06
stem_file_df_06 = pd.read_csv('Decoy Seq Stem Cell File 6.csv', header=0)
stem_file_df_06 = stem_file_df_06[stem_file_df_06['pep_scores'] <= 1.0]

# remove decoys of canonical and variants
stem_file_df_06 = stem_file_df_06[stem_file_df_06['psm_type'] == 'target_seq_target_var']
...
# STEM FILE 07
stem_file_df_07 = pd.read_csv('Decoy Seq Stem Cell File 7.csv', header=0)
stem_file_df_07 = stem_file_df_07[stem_file_df_07['pep_scores'] <= 1.0]

# remove decoys of canonical and variants
stem_file_df_07 = stem_file_df_07[stem_file_df_07['psm_type'] == 'target_seq_target_var']
...
# STEM FILE 08
stem_file_df_08 = pd.read_csv('Decoy Seq Stem Cell File 8.csv', header=0)
stem_file_df_08 = stem_file_df_08[stem_file_df_08['pep_scores'] <= 1.0]

# remove decoys of canonical and variants
stem_file_df_08 = stem_file_df_08[stem_file_df_08['psm_type'] == 'target_seq_target_var']
...
# STEM FILE 09
stem_file_df_09 = pd.read_csv('Decoy Seq Stem Cell File 9.csv', header=0)
stem_file_df_09 = stem_file_df_09[stem_file_df_09['pep_scores'] <= 1.0]

# remove decoys of canonical and variants
stem_file_df_09 = stem_file_df_09[stem_file_df_09['psm_type'] == 'target_seq_target_var']
...
# STEM FILE 10
stem_file_df_10 = pd.read_csv('Decoy Seq Stem Cell File 10.csv', header=0)
stem_file_df_10 = stem_file_df_10[stem_file_df_10['pep_scores'] <= 1.0]

# remove decoys of canonical and variants
stem_file_df_10 = stem_file_df_10[stem_file_df_10['psm_type'] == 'target_seq_target_var']
...
# STEM FILE 11
stem_file_df_11 = pd.read_csv('Decoy Seq Stem Cell File 11.csv', header=0)
stem_file_df_11 = stem_file_df_11[stem_file_df_11['pep_scores'] <= 1.0]

# remove decoys of canonical and variants
stem_file_df_11 = stem_file_df_11[stem_file_df_11['psm_type'] == 'target_seq_target_var']
...
# STEM FILE 12
stem_file_df_12 = pd.read_csv('Decoy Seq Stem Cell File 12.csv', header=0)
stem_file_df_12 = stem_file_df_12[stem_file_df_12['pep_scores'] <= 1.0]

# remove decoys of canonical and variants

stem_file_df_12 = stem_file_df_12[stem_file_df_12['psm_type'] == 'target_seq_target_var']
...
MODY_df['Stage 0: wild type_01'] = MODY_df['Stage 0: wild type_01'].fillna(1.1)
MODY_df['Stage 0: wild type_02'] = MODY_df['Stage 0: wild type_02'].fillna(1.1)
MODY_df['Stage 0: wild type_03'] = MODY_df['Stage 0: wild type_03'].fillna(1.1)
MODY_df['Stage 0: mutant_01'] = MODY_df['Stage 0: mutant_01'].fillna(1.1)
MODY_df['Stage 0: mutant_02'] = MODY_df['Stage 0: mutant_02'].fillna(1.1)
MODY_df['Stage 0: mutant_03'] = MODY_df['Stage 0: mutant_03'].fillna(1.1)
MODY_df['Stage 4: wild type_01'] = MODY_df['Stage 0: wild type_01'].fillna(1.1)
MODY_df['Stage 4: wild type_02'] = MODY_df['Stage 4: wild type_02'].fillna(1.1)
MODY_df['Stage 4: wild type_03'] = MODY_df['Stage 4: wild type_03'].fillna(1.1)
MODY_df['Stage 4: mutant_01'] = MODY_df['Stage 4: mutant_01'].fillna(1.1)
MODY_df['Stage 4: mutant_02'] = MODY_df['Stage 4: mutant_02'].fillna(1.1)
MODY_df['Stage 4: mutant_03'] = MODY_df['Stage 4: mutant_03'].fillna(1.1)
...
plt.title('Decoy seq strategy: PEP distribution of variant PSMs from classified iPSCs of possible MODY genes')
plt.legend(MODY_df.columns, bbox_to_anchor=(1, 1), loc='upper left', title='iPSCs growth stage and type')
plt.savefig('variant iPSCs 14 MODY pep distribution decoy sequence search', bbox_inches='tight', dpi=600)
plt.show()
