...
stem_file_df_12 = stem_file_df_12[stem_file_df_12['psm_type'] != 'canonical']
...
plt.title('Decoy variant strategy: PEP distribution of canonical and variant PSMs from classified iPSCs of possible MODY genes')
plt.legend(MODY_df.columns, bbox_to_anchor=(1, 1), loc='upper left', title='iPSCs growth stage and type')
plt.savefig('iPSCs all MODY pep distribution decoy variant search.png', bbox_inches='tight', dpi=600)
plt.show()
